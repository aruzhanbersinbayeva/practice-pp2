...
class MickeyClock:
    def __init__(self, screen_width, screen_height):
        # Оставляем твои исходные размеры экрана и центр
        ...
        # 3. Загрузка рук (используем hand_left_centered и hand_right_centered)
        # Минутная стрелка (правая рука по твоему коду)
        ...
        # Секундная стрелка (левая рука по твоему коду)
    ...
    def blit_rotate_pivot(self, surface, image, pos, originPos, angle):
        """ Вращение вокруг заданной точки (плеча) """
    ...
    def render(self, surface):
        ...
        # Точки вращения (низ центра каждой картинки)
